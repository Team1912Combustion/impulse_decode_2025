...
public class PIDShooter extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double left_vel = left_motor.getVelocity() * 60. / TICKS_PER_REV;
            double right_vel = right_motor.getVelocity() * 60. / TICKS_PER_REV;
            ...
            telemetry.addData("Target", "RPM (%.2f)", TARGET_RPM);
            telemetry.addData("Measured RPM", "left (%.2f), right (%.2f)", left_vel, right_vel);
            telemetry.update();
        }
    }
}
